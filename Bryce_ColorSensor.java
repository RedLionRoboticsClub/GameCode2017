 ...
 */
@com.qualcomm.robotcore.eventloop.opmode.Autonomous(name="Bryce_SensorColor", group ="Tests")
public class Bryce_SensorColor extends LinearOpMode
{
...
//        motorThrow.setPower(power);
  ...
  public void colorRead() throws InterruptedException
  {
    ...
    if (colorSensor.red() >= 2) {
      ...
      addLog("GLaDOS sees red");
      motorThrowing(.5,5000);
    }
    else {
      //move left wheel forward
      addLog("GLaDOS sees not red");
      motorThrowing(-.5,5000);
    }
  }
}
